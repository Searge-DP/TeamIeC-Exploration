...
public class IeCEBlocks {
	...
	public static void preInit(){
		...
		GameRegistry.registerBlock(IeCEOreStorage = (new IeCEOreStorage(Material.iron)).setCreativeTab(IeCExplorationTabs.tabBlocks).setBlockName("oreblocks"), IeCEOreStorageI.class, "IeCEOreStorage");
	}
